...
\begin{multicols}{3}
    ...
    \begin{tabular}{l|l}
        ...
        $\varnothing$ oder \verb!{}! & \verb!Leere Menge, enthält keine Elemente!       \\
        $x\in A$                     & \verb!Beschreibt Element x ist in Menge A!       \\
        $x\notin A$                  & \verb!Beschreibt Element x ist nicht in Menge A! \\
        $A\subset B$                 & \verb!A ist eine Teilmenge von B!                \\
        $A\cap B$                    & \verb!Schnittmenge von A und B!                  \\
        $A\cup B$                    & \verb!Vereinigunsgsmenge von A und B!            \\
